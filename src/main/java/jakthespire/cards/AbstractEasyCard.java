...
import jakthespire.util.CardArtRoller;

import static jakthespire.ModFile.makeImagePath;
import static jakthespire.ModFile.modID;
import static jakthespire.util.Wiz.atb;
import static jakthespire.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheSidekick.Enums.MAR_COLOR);
    }
    ...
    protected void dmgRan(AbstractGameAction.AttackEffect fx) {
        atb(new DamageRandomEnemyAction(new DamageInfo(AbstractDungeon.player, damage, damageTypeForTurn), fx));
    }

    protected void dmgRanTop(AbstractGameAction.AttackEffect fx) {
        att(new DamageRandomEnemyAction(new DamageInfo(AbstractDungeon.player, damage, damageTypeForTurn), fx));
    }
