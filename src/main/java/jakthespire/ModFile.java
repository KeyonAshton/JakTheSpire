...
import jakthespire.cards.cardvars.SecondDamage;
import jakthespire.cards.cardvars.SecondMagicNumber;
import jakthespire.relics.AbstractEasyRelic;
...
public class ModFile implements
    ...
    public static final String modID = "jakthespire"; //TODO: Change this.

    public static String makeID(String idText) {
        return modID + ":" + idText;
    }

    public static Color marColor = new Color(137f/255f, 85f/255f, 48f/255f, 1); // This should be changed eventually
    ...
    public ModFile() {
        ...
        BaseMod.addColor(TheSidekick.Enums.MAR_COLOR, marColor, marColor, marColor,
                marColor, marColor, marColor, marColor,
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new TheSidekick(TheSidekick.characterStrings.NAMES[1], TheSidekick.Enums.THE_SIDEKICK),
                CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, TheSidekick.Enums.THE_SIDEKICK);
    }
