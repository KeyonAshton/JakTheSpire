...
import jakthespire.ModFile;
import jakthespire.util.TexLoader;
...
public abstract class AbstractEasyPower extends AbstractPower {
    ...
    public AbstractEasyPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        ...
        Texture hiDefImage = TexLoader.getTexture(ModFile.modID + "Resources/images/powers/big" + ID.replaceAll(ModFile.modID + ":", "") + ".png");
        if (hiDefImage != null) {
